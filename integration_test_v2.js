...
async function runTests() {
  ...
  test('package.json version is 7.0.0', pkgContent.version === '7.0.0');
  test('config.ts APP_VERSION is 7.0.0', configContent.includes("'7.0.0'"));
  ...
  if (fs.existsSync(infoPlistPath)) {
    ...
    test('Info.plist has version 7.0.0', plistContent.includes('7.0.0'));
  ...
  if (fs.existsSync(buildGradlePath)) {
    ...
    test('build.gradle versionCode is 101', gradleContent.includes('versionCode 700'));
    test('build.gradle versionName is 7.0.0', gradleContent.includes('7.0.0'));
  } else {
